...
[<EntryPoint>]
let main argv =
    let testUrlPath = Path.Combine(__SOURCE_DIRECTORY__, "output", "Urls", "Urls_1Thru300.json")
    let outputPath = Path.Combine(__SOURCE_DIRECTORY__, "output", "Pages", "Urls_1Thru300.json")
    let mdPath = Path.Combine(__SOURCE_DIRECTORY__, "output", "Pages", "Urls_1Thru300.md")
